...
.DATA
    ...
    MONSTER_X       DW ?
    MONSTER_Y       DW ?
    MONSTER_SIZE_X  DW 35;25 
    MONSTER_SIZE_Y  DW 40;30    
    ...
    DONE_SCROLLING      DB 0
    FIRST_SCROLL        DB 1
    JAYI_KE_QAM_NABASHE DW 100  ; The less it gets, the harder the game is 
...
.CODE  
    ...
    DRAW_MONSTER PROC FAR   ; AX = Input, = 0, generate else draw
        CMP AX, 0
        JNE SAVE_PIXELS
            MOV IS_MONSTER_IN, 1
            NEG MONSTER_SPEED
    ...
    MOVE_BALL PROC FAR
        ...
        MOV AX, BALL_ACCEL_HIT
        CMP BALL_ACCEL_IT, AX
        JL MOVE_IN_Y_AXIS

            MOV BALL_ACCEL_IT, 0    ; RESET ITERATOR
            CMP JUMP, 0
            JE NEG_ACCEL

            CMP BALL_VELOCITY_Y, -4       ; BALL_ACCEL MUST BE GREATER THAN 0
            JGE APPLY_ACCEL
                INC BALL_VELOCITY_Y
                JMP APPLY_ACCEL

            NEG_ACCEL:              ; BALL_ACCEL MUST BE LESS THAN 0
                CMP BALL_VELOCITY_Y, 8
                JGE APPLY_ACCEL
                    INC BALL_VELOCITY_Y
